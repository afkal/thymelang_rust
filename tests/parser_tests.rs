...
fn test_additive_expression() {
    ...
    let result = &prs.parse().children[0].children[0]; // Program.PrintStatement.Children
...
fn test_order_of_operation() {
    let mut prs = parser::Parser::new("print(1+2*3)");
    let result = &prs.parse().children[0].children[0]; // Program.PrintStatement.Children
...
fn test_inline_comment() {
    let mut prs = parser::Parser::new("print(1); // comment");
    let result = &prs.parse().children[0].children[0]; // Program.PrintStatement.Children
